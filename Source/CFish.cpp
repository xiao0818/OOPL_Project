...
namespace game_framework {
	void CFish::LoadBitmap()
	{
		...
		flyLeftAnimation.AddBitmap(IDB_FISH_FLY_LEFT_001, RGB(0, 0, 0));
		flyLeftAnimation.AddBitmap(IDB_FISH_FLY_LEFT_002, RGB(0, 0, 0));
		flyLeftAnimation.AddBitmap(IDB_FISH_FLY_LEFT_003, RGB(0, 0, 0));
		flyLeftAnimation.AddBitmap(IDB_FISH_FLY_LEFT_004, RGB(0, 0, 0));
		flyLeftAnimation.AddBitmap(IDB_FISH_FLY_LEFT_005, RGB(0, 0, 0));
		flyLeftAnimation.AddBitmap(IDB_FISH_FLY_LEFT_006, RGB(0, 0, 0));
		flyLeftAnimation.AddBitmap(IDB_FISH_FLY_LEFT_007, RGB(0, 0, 0));
		flyLeftAnimation.AddBitmap(IDB_FISH_FLY_LEFT_008, RGB(0, 0, 0));
		flyRightAnimation.AddBitmap(IDB_FISH_FLY_RIGHT_001, RGB(0, 0, 0));
		flyRightAnimation.AddBitmap(IDB_FISH_FLY_RIGHT_002, RGB(0, 0, 0));
		flyRightAnimation.AddBitmap(IDB_FISH_FLY_RIGHT_003, RGB(0, 0, 0));
		flyRightAnimation.AddBitmap(IDB_FISH_FLY_RIGHT_004, RGB(0, 0, 0));
		flyRightAnimation.AddBitmap(IDB_FISH_FLY_RIGHT_005, RGB(0, 0, 0));
		flyRightAnimation.AddBitmap(IDB_FISH_FLY_RIGHT_006, RGB(0, 0, 0));
		flyRightAnimation.AddBitmap(IDB_FISH_FLY_RIGHT_007, RGB(0, 0, 0));
		flyRightAnimation.AddBitmap(IDB_FISH_FLY_RIGHT_008, RGB(0, 0, 0));
		flyDownAnimation.AddBitmap(IDB_FISH_FLY_DOWN_001, RGB(0, 0, 0));
		flyDownAnimation.AddBitmap(IDB_FISH_FLY_DOWN_002, RGB(0, 0, 0));
		flyDownAnimation.AddBitmap(IDB_FISH_FLY_DOWN_003, RGB(0, 0, 0));
		flyDownAnimation.AddBitmap(IDB_FISH_FLY_DOWN_004, RGB(0, 0, 0));
		flyDownAnimation.AddBitmap(IDB_FISH_FLY_DOWN_005, RGB(0, 0, 0));
		flyDownAnimation.AddBitmap(IDB_FISH_FLY_DOWN_006, RGB(0, 0, 0));
		flyDownAnimation.AddBitmap(IDB_FISH_FLY_DOWN_007, RGB(0, 0, 0));
		flyDownAnimation.AddBitmap(IDB_FISH_FLY_DOWN_008, RGB(0, 0, 0));
		flyUpAnimation.AddBitmap(IDB_FISH_FLY_UP_001, RGB(0, 0, 0));
		flyUpAnimation.AddBitmap(IDB_FISH_FLY_UP_002, RGB(0, 0, 0));
		flyUpAnimation.AddBitmap(IDB_FISH_FLY_UP_003, RGB(0, 0, 0));
		flyUpAnimation.AddBitmap(IDB_FISH_FLY_UP_004, RGB(0, 0, 0));
		flyUpAnimation.AddBitmap(IDB_FISH_FLY_UP_005, RGB(0, 0, 0));
		flyUpAnimation.AddBitmap(IDB_FISH_FLY_UP_006, RGB(0, 0, 0));
		flyUpAnimation.AddBitmap(IDB_FISH_FLY_UP_007, RGB(0, 0, 0));
		flyUpAnimation.AddBitmap(IDB_FISH_FLY_UP_008, RGB(0, 0, 0));
	}
}